...
namespace CsharpProgrammingII_StudentRegistrationSystem
{
    ...
    public class Student : Person
    {
        ...
        //Students' methods()
        public void selectDB(int id) //Selecting student from his/her ID number
        {
            DBSetup();
        ...
        public void getSchedule(int id) //SELECTing schedule for Student
        {
            DBSetup();
            string cmd = "SELECT CRN FROM StudentSchedule WHERE StudentID = " + id;
            OleDbDataAdapter2.SelectCommand.CommandText = cmd;
            OleDbDataAdapter2.SelectCommand.Connection = OleDbConnection2;
            Console.WriteLine(cmd);
            try
    ...
    public class Instructor : Person
    {
        ...
        public void getSchedule(int id) //SELECTing schedule for Instructor(s)
        {
            DBSetup();
            string cmd = "SELECT CRN FROM Sections WHERE Instructor = " + id;
            OleDbDataAdapter2.SelectCommand.CommandText = cmd;
            OleDbDataAdapter2.SelectCommand.Connection = OleDbConnection2;
            Console.WriteLine(cmd);
            try
